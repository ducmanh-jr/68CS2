...
const int a1 = 30;//max ngay
const int a2 = 100;//max_nguyen_lieu


void nhaps1(int s1[][a2], int s2) {//chi hi ngay ngay
    int s3;//songuyenlieu
    cout << "Nhập số lượng nguyên liệu cần mua: ";
    cin >> s3;
    for (int i = 0; i < s3; i++) {
        string s4;//ten nguyen lieu
        int s5;//gia
...
void timKiemNguyenLieu(int s1[][a2], int z2, string s4) {//z2 so ngay
    cout << "Kết quả tìm kiếm cho \"" << s4 << "\":\n";
    bool z3 = false;//tim thay
    for (int i = 0; i < z2; i++) {
